this["component-autocomplete"] = {"1":function(depth0,helpers,partials,data) {
  ...
  "\n<form class=\"autocomplete-form autocomplete-"
    ...
    + "\"\n        data-component-predetermined-result-set=\""
    + alias3(((helper = (helper = helpers.predeterminedResultSet || (depth0 != null ? depth0.predeterminedResultSet : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"predeterminedResultSet","hash":{},"data":data}) : helper)))
    + "\"\n    >\n    <a href=\"#!\" class=\"submit js-submit fa fa-search\"></a>\n\n";
